        ...
        <nav className="fixed w-full top-0 z-50 bg-white px-6 shadow-md">
          ...
          {menuOpen && (
            <ul className="lg:hidden mt-4 p-4 space-y-3 rounded-lg">
              <li><Link href="/" className="block text-[#000022]" onClick={() => setMenuOpen(false)}>Home</Link></li>
              ...
              <li><Link href="/join-us" className="block text-[#000022]" onClick={() => setMenuOpen(false)}>Join us</Link></li>
          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="md:w-2/4 flex justify-around mt-6 md:mt-0">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/join-us" className="hover:underline">Join us</Link></li>
